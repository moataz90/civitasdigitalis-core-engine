 ...
 */
    static buildMessage(payload, messageType) {
        ...
        if (messageType === commonInterfaces_1.StepType.Carousel) {
            return JSON.stringify(carouselMessage);
        }
        else if (messageType === commonInterfaces_1.StepType.Category) {
            return JSON.stringify(categoryMessage);
        }
        else if (messageType === commonInterfaces_1.StepType.Tags) {
